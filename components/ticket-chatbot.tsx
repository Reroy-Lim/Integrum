    ...
    <>
      <AlertDialog open={showResolveDialog} onOpenChange={setShowResolveDialog}>
        <AlertDialogContent className="bg-gray-900 border border-gray-700">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-white text-lg">Confirm to Resolve the Tickets?</AlertDialogTitle>
            <AlertDialogDescription className="text-gray-400">
              This will mark the ticket as resolved and disable further chat messages.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
